...
exports.ToolchainDetectionServiceTest = void 0;
exports.runToolchainDetectionTests = runToolchainDetectionTests;
/**
 * 工具链检测服务测试模块
 * 验证统一检测服务的功能和兼容性
 *
 ...
 * 简单的测试套件用于验证工具链检测服务
 */
class ToolchainDetectionServiceTest {
    service;
    constructor() {
        this.service = toolchainDetectionService_1.ToolchainDetectionService.getInstance();
    }
    /**
     * 测试基本检测功能
     */
    async testBasicDetection() {
        try {
            ...
            // 验证状态枚举
            const validStatuses = [
                types_1.DetectionStatus.SUCCESS,
                types_1.DetectionStatus.FAILED,
                types_1.DetectionStatus.NOT_DETECTED
            ];
...
exports.ToolchainDetectionServiceTest = ToolchainDetectionServiceTest;
/**
 * 导出测试运行函数
 */
async function runToolchainDetectionTests() {
    const testSuite = new ToolchainDetectionServiceTest();
    return await testSuite.runAllTests();
}
//# sourceMappingURL=toolchainDetectionService.test.js.map